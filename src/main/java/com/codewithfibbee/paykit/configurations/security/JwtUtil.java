...
import static com.codewithfibbee.paykit.constants.Constants.AUTHORITIES_CLAIM_KEY_SEP;
import static com.codewithfibbee.paykit.constants.Constants.USER_TYPE;
...
public class JwtUtil implements AuthTokenProvider {
    ...
    public Collection<String> extractAuthoritiesClaims(String token) {
        ...
        if(claims.get(AUTHORITIES_KEY)!=null) {
            return Arrays.asList(((String) claims
                    .get(AUTHORITIES_KEY))
                    .split(AUTHORITIES_CLAIM_KEY_SEP));
        }
