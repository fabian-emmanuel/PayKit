...
public class SchemaConstant {
    ...
    public static final String PAY_KIT_SCHEMA = "PayKit";
    ...
    public static final String DEFAULT_APP_NAME = "Pay Kit Application";
    ...
    public static final String TABLE_VENDOR_USER ="vendor_user";
    public static final String TABLE_VENDOR_LOGIN_HISTORY ="vendor_login_history";
    public static final String TABLE_AFFILIATE_USER ="affiliate_user";
    ...
    public static final String TABLE_ROLE_PERMISSION="role_permissions";
