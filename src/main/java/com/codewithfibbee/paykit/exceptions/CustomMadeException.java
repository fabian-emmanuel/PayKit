...
import com.codewithfibbee.paykit.configurations.system.PropertiesConfig;
...
public class CustomMadeException {
    ...
    @Autowired
    public CustomMadeException(PropertiesConfig propertiesConfig) {
        CustomMadeException.propertiesConfig = propertiesConfig;
    }
    ...
    private static RuntimeException throwException(ExceptionType exceptionType, String messageTemplate, String... args) {
        if (ExceptionType.ENTITY_NOT_FOUND.equals(exceptionType)) {
            ...
            return new UnAuthorizeException(format(messageTemplate, args));
        }
        return new RuntimeException(format(messageTemplate, args));
    }
